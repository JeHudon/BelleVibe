				...
				{onglet === "resume" && (
					<div className="box" style={{ border: "1px solid #d6d6d6" }}>
						<div className="level mb-4">
							<div className="level-left">
								<h1 className="title is-5">Détails du client</h1>
							</div>
					...
					<div className="columns">
						<div className="column is-6">
							...
							<div className="control">
								<p className="has-text-weight-bold">{client?.nomClient}</p>
							</div>
						</div>
						<div className="column is-6">
							<label>Prénom :</label>
							<div className="control">
								<p className="has-text-weight-bold">{client?.prenomClient}</p>
							</div>
						</div>
					</div>
					<div className="columns">
					...
					<div className="columns">
						...
						<div className="column is-6">
							...
							<div className="control">
								<p className="has-text-weight-bold">{client?.codePostalClient}</p>
							</div>
						</div>
					</div>
					</div>
