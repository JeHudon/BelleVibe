...
export default function CreerEmploye() {
	...
	return (
		<div style={{ maxWidth: 1100, margin: "0 auto" }}>
			<div className="mb-4">
				<button className="button is-white px-2" onClick={() => navigate(-1)} type="button">
					<span className="icon">
			...
			<form onSubmit={handleSubmit}>
				<div className="box">
					<h3 className="title is-4">Informations de l'employé</h3>
						...
						<div className="column">
							<div className="field">
								...
								<div className="control has-icons-right">
									...
									>
										<i
											className={`fa-solid ${showMdp ? "fa-eye-slash" : "fa-eye"}`}
										/>
									</span>
								</div>
							</div>
